...
import com.senatic.votingserver.service.VotosService;
...
public class VotosController {
    ...
    */
    ...
    //@Timed(value = "handleSaveVoto.time", description = "Time taken to save Voto")
    public ResponseEntity<HttpStatus> handleSaveVoto(@PathVariable("idCandidato") Integer idCandidato) {
